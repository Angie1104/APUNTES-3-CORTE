 ...
 *Reemplazamos condiciones iniciales
  ...
  *Transformada inversa
  ...
  <a href="http://www.alciro.org/tools/matematicas/editor-ecuaciones.jsp?eq==(2a+b)e^{-1}-(a+b)e^{-2t}}"><img src="http://www.alciro.org/cgi/tex.cgi?=(2a+b)e^{-1}-(a+b)e^{-2t}}" title="=(2a+b)e^{-1}-(a+b)e^{-2t}}" border="0" /></a>
