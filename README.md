...
<a href="http://www.alciro.org/tools/matematicas/editor-ecuaciones.jsp?eq=\text{1. Se calcula }Y_1(s): \\Y_1(s) = G_1(s)X_1(s) - G_2(s)X_1(s) \\Y_1(s) = \left(G_1(s) - G_2(s)\right)X_1(s) \\\text{2. Se pasa } Y_1(s) \text{ por } G_3(s): \\
Y_3(s) = G_3(s) \cdot Y_1(s) = G_3(s)\left(G_1(s) - G_2(s)\right)X_1(s) \\\text{3. Como } Y(s) = Y_3(s) + Y_2(s), \text{ y aquí } X_2(s) = 0, \text{ entonces:} \\
Y(s) = Y_3(s) = G_3(s)\left(G_1(s) - G_2(s)\right)X_1(s) \\\Rightarrow {\frac{Y(s)}{X_1(s)} = G_3(s)\left(G_1(s) - G_2(s)\right)}"><img src="http://www.alciro.org/cgi/tex.cgi?\text{1. Se calcula } Y_1(s): \\
Y_1(s) = G_1(s)X_1(s) - G_2(s)X_1(s) \\
Y_1(s) = \left(G_1(s) - G_2(s)\right)X_1(s) \\
\text{2. Se pasa } Y_1(s) \text{ por } G_3(s): \\
Y_3(s) = G_3(s) \cdot Y_1(s) = G_3(s)\left(G_1(s) - G_2(s)\right)X_1(s) \\
\text{3. Como } Y(s) = Y_3(s) + Y_2(s), \text{ y aquí } X_2(s) = 0, \text{ entonces:} \\
Y(s) = Y_3(s) = G_3(s)\left(G_1(s) - G_2(s)\right)X_1(s) \\
\Rightarrow {\frac{Y(s)}{X_1(s)} = G_3(s)\left(G_1(s) - G_2(s)\right)}
" title="\text{1. Se calcula } Y_1(s): \\
Y_1(s) = G_1(s)X_1(s) - G_2(s)X_1(s) \\
Y_1(s) = \left(G_1(s) - G_2(s)\right)X_1(s) \\
\text{2. Se pasa } Y_1(s) \text{ por } G_3(s): \\
Y_3(s) = G_3(s) \cdot Y_1(s) = G_3(s)\left(G_1(s) - G_2(s)\right)X_1(s) \\
\text{3. Como } Y(s) = Y_3(s) + Y_2(s), \text{ y aquí } X_2(s) = 0, \text{ entonces:} \\
Y(s) = Y_3(s) = G_3(s)\left(G_1(s) - G_2(s)\right)X_1(s) \\\Rightarrow {\frac{Y(s)}{X_1(s)} = G_3(s)\left(G_1(s) - G_2(s)\right)}" border="0" /></a>
